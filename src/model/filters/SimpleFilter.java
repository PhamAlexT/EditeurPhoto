...
public class SimpleFilter extends Filter<Function<Color,Color>> implements Function<Image, Image> {

    private String name;
    private Function<Color, Color> colorMap;

    public SimpleFilter(String name, Function<Color, Color> colorMap) {
        this.name = name;
